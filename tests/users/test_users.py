...
class TestUsers:
    ...
    @pytest.mark.users
    @pytest.mark.regression
    def test_get_user_me(self, func_user: UserFixture, private_users_client: PrivateUsersClient):
        response = private_users_client.get_user_me_api()
        response_data = GetUserResponseSchema.model_validate_json(json_data=response.text)
