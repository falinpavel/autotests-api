...
class TestAuthentication:
    def test_login(self, func_user: UserFixture, authentication_client: AuthenticationClient):
        ...
        response_data = LoginResponseSchema.model_validate_json(json_data=response.text)
